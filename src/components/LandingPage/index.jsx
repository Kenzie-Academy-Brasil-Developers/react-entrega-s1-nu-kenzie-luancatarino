...
function LandingPage({home}) {
    return (
        <body id="bodyLandPage">
        <main id="mainLandPage">
            <section id="geral">
                ...
                <button id="btnLandPage"onClick={() => home()}>Iniciar</button>
            </section>
            <div>
                <svg width="593" height="593" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g filter="url(#a)"><rect x="220" y="307" width="231.786" height="69" rx="2.68" fill="#fff" /></g>
                    ...
                    <g clip-path="url(#b)" stroke="#fff" stroke-width="1.34" stroke-linecap="round" stroke-linejoin="round">
                        <path
                            d="M258.184 336.476h-12.058c-.74 0-1.34.6-1.34 1.34v8.038c0 .74.6 1.34 1.34 1.34h12.058c.74 0 1.34-.6 1.34-1.34v-8.038c0-.74-.6-1.34-1.34-1.34ZM244.786 340.495h14.738"
                        />
                    </g>
                    <g filter="url(#c)"><rect x="81.481" y="238.105" width="313.249" height="93.25" rx="3.621" fill="#fff" /></g>
                    ...
                    <g clip-path="url(#d)" stroke="#fff" stroke-width="1.811" stroke-linecap="round" stroke-linejoin="round">
                        <path
                            d="M133.086 277.94h-16.297c-1 0-1.81.811-1.81 1.811v10.864c0 1 .81 1.811 1.81 1.811h16.297c1 0 1.81-.811 1.81-1.811v-10.864c0-1-.81-1.811-1.81-1.811ZM114.979 283.373h19.917"
                        />
                    </g>
                    <g filter="url(#e)"><rect x="81.481" y="238.105" width="313.249" height="93.25" rx="3.621" fill="#fff" /></g>
                    <rect x="95.061" y="256.212" width="60.658" height="57.942" rx="3.621" fill="#FD377E" />
                    <rect x="167.489" y="256.212" width="206.418" height="15.391" rx="1.811" fill="#FCEFFA" />
                    <rect x="167.489" y="281.562" width="52.51" height="15.391" rx="1.811" fill="#FCEFFA" />
